...
<br><br><br><br>
<form name="principal" id="principal" action="agregarmemoria.php" method="post">
<div class="page secondary">
	<div class="page-header">
		<div class="page-header-content">
        	        <h1>Alta Tipo y Cantidad Memoria<small>beta</small></h1>
	...
	<div id="secundario">
			<center>
    			<div class="input-control text span7">
        			<input type="text" name="memoria" placeholder="Memoria" text="">
