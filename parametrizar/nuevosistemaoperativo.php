...
<br><br><br><br>
<form name="principal" id="principal" action="agregarsistemaoperativo.php" method="post">
<div class="page secondary">
	<div class="page-header">
		<div class="page-header-content">
        	        <h1>Alta Sistema Operativo<small>beta</small></h1>
	...
	<div id="secundario">
			<center>
    			<div class="input-control text span7">
        			<input type="text" name="sistemaoperativo" placeholder="Sistema Operativo" text="">
