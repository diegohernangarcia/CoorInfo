<?php
	...
	//html PNG location prefix
 	...
 	//echo("<br><br>");
 	NuevoRegistroImpresoraLocal($ultimoid);
	...
	if (!isset($_SESSION["datos_codigo_barras"])) {
        ...
        AgregarImpresoraLocal($quearea,$oficina,$queimpresora,$serialimpresora,$querango,$ip);
