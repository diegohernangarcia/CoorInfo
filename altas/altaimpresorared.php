...
?>
<form name="altaimpresorared" id="altaimpresoralocal"  action="grabarimpresorared.php" method="post">
	<div class="page secondary">
	<div class="page-header">
		<div class="page-header-content">
        	        <h1>Alta Impresoras En Red<small>beta</small></h1>
