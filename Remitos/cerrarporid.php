<?php
    ...
    EstaIncidentePorId($incidente,$salida);
    if ($salida==0) {
        echo("No Existe incidente");
            ...
            $consultaPrinter="SELECT * FROM remitoingreso WHERE id='".$incidente."'";
            //echo ($consulta);
    ...
    ?>
    <form name="cerrar" id="cerrar" action="cerrar_id.php" method="post">
        <br>
