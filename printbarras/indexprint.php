...
<form name="altaequipo" id="nuevaincidencia" action="print2.php" method="post"> 
<center><img src="../images/logo.jpg" width="750" height="80" alt="LOGO MINISTERIO" align="middle"></center>
<div class="page secondary">
         <div class="page-header">
            <div class="page-header-content">
                 <h1>Re-impresion Etiquetas<small>beta</small></h1>
            </div>
         </div>
         <div class="page-region">
            <div class="page-region-content">
                ...
                <div class="page-control span11" data-role="page-control">
                    ...
                    <ul>
                        <li><a href="#page1">Por Ip</a></li>
                        <li><a href="#page2">Por Id</li>
                        <li><a href="#page3">Por Usuario</a></li> 
                    </ul>
                  <div class="frames">
